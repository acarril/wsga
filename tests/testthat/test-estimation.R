...
test_that("wsga_rdd runs without error (no IPW, no bootstrap)", {
...
test_that("wsga_rdd with IPW runs and balance tables are returned", {
...
test_that("fuzzy IV model runs", {
  ...
  rf <- wsga_rdd(y ~ 1 | sgroup, data = rddsga_synth,
